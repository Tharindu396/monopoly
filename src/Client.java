...
public class Client extends JFrame {
    ...
    public Client() {
        ...
        for (int i=0; i<number; i++){
            ...
            btnRoll[i].addActionListener((ActionListener) this);
        ...
        btnQuit.addActionListener((ActionListener) this);
        txtChat.addActionListener((ActionListener) this);
    ...
    public void move(JLabel lblFace, int n, int player){
        ...
        lp.remove(lblFace);
        lp.add(lblFace, 1); // Correct (Autoboxing)
    ...
    public void sendPlayerDetails(){
        action.sendData(SENDPD);
        action.sendMessage(name);
        action.sendData(player);
        action.sendData(cash);
    }
